  ...
  return (
    <div className="main-container w-[1728px] h-[5612px] bg-[#fff] relative overflow-hidden mx-auto my-0">
      ...
      <span className="flex w-[792px] h-[536px] justify-start items-start font-['Inter'] text-[27.420000076293945px] font-light leading-[33.184px] text-[#000] relative text-left z-[19] mt-[154px] mr-0 mb-0 ml-[137px]">
        ...
        governance. She has worked with approximately 100 stakeholders in four
        African countries, including Botswana, Ethiopia, Ghana, Kenya, and the
        United Kingdom.
        <br />
      </span>
      <span className="flex w-[792px] h-[536px] justify-start items-start font-['Inter'] text-[27.420000076293945px] font-light leading-[33.184px] text-[#000] relative text-left z-20 mt-[361px] mr-0 mb-0 ml-[813px]">
        ...
        including “The Educational impact Project”, geared towards supporting
        and improving the quality of education in schools, with the goal of
        making them fit and conducive for learning, and by effect, advancing the
        goal of SDG 4. The Educational Impact Project won the Organization
        AU$40,000 from the Australian Embassy in 2016, and she was also involved
        in other tasks within various projects (producing books, leaflets,
        posters, budgets, etc.). With her computer skills, she was also very
        useful for helping over 30 farmers' children gain computer knowledge in
        a Project called Smart Agriculture: so many of them were, with her help,
      ...
      <div className="w-[1468px] h-[1151px] font-['Inter'] text-[27.420000076293945px] font-light leading-[33.184px] relative text-left z-[21] mt-[106px] mr-0 mb-0 ml-[137px]">
        <span className="font-['Inter'] text-[27.420000076293945px] font-light leading-[33.184px] text-[#000] relative text-left">
          ...
          Executive, Cardiff University, Wales, United Kingdom and sits on both
          local and international boards.
          <br />
          <br />
          In 2018, following a real time survey, Precious discovered that
          Nigeria suffers lots of issues, from reducing 10.2 million
          out-of-school children to a situation where unemployment rate jumped
          from 18.1% to 23.1% between 2017 and 2018, which has been
          disproportionately borne by young people with almost 30% of them out
        ...
        <span className="font-['Inter'] text-[27.420000076293945px] font-light leading-[33.184px] text-[#000] relative text-left">
          ...
          future of work and globalization. The 10-year Skill-Up-Climb-Up human
          capacity development project was designed to impact 50,000 young
          people by 2030, with ongoing projects in Abuja, Rivers and Taraba.
          This initiative has empowered over 500 women, 50 creatives, and
          provided employment for 20 creatives.
          <br />
          <br />
          During the Ministerial round table on ICT for skills development
          hosted by the African Union and Government of Botswana in 2019, the
          Skill-Up-Climb-Up initiative was applauded as the 21st century
          innovation to look out for. Various States in Nigeria have indicated
          interest to replicate this initiative in their States. The initiative
          is contributing to the achievements of improving access to quality
          education and opportunity for young people using Skills and Human
          Capacity Development.
          <br />
          <br />
          Over the span of 6 years, she has worked actively to ensure women,
          girl children and youth get access to inclusive and quality education
          and equal opportunities through her various initiatives at “DO”
          (dotakeaction.org), and over 10,000 lives have been tremendously
          impacted through her work. Her work and impact were featured in a
          France journal publication:
          https://olbios.org/if-you-want-to-change-the-minds-change-the-infrastructure/
          and also on a United States Magazine and Podcast:
          http://ladybrillemag.com/preciousebere/
          <br />
          <br />
          These milestones are worth recognition on a global stage.
          <br />
          With DO, Precious' future plans are embedded in her VISION STATEMENT:
          Change by Africans for Africa. She sees a Nigeria where every
          Nigerian, irrespective of tribe, age, religion, takes individual
          responsibility for Africa's change and sustainable development, whilst
          making a difference in their community. All this whilst spreading her
          tentacles in the African community, to drive sustainable development
          at scale by building an active community of young and old people
          taking action at every turn, to solve key issues facing their
          communities. Precious' Goal by 2030, is to build an active community
          of young and old people taking action to solve key issues facing their
          communities, factoring the below-stated metrics.
          <br />
        </span>
      </div>
